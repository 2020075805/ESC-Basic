...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phoneHum.setText(getphoneNum);
        phoneHum.addTextChangedListener(new PhoneNumberFormattingTextWatcher());
    }


    private void setUpUI() {
        toolbar = findViewById(R.id.message_toolbar);
        phoneHum = findViewById((R.id.message_et_phone));
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    smsManager.sendTextMessage(phoneHum.getText().toString(),null, content.getText().toString(),null,null);
                    finish();
